...
public:
	...
	virtual SoundPlaybackID		StartSound( SoundID soundID, bool isLooped=false, float volume=0.5f, float balance=0.0f, float speed=1.0f, bool isPaused=false );
	...
	virtual bool				IsPlaying( SoundPlaybackID soundPlaybackID );
